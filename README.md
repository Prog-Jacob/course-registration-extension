...
1. [Click to download extension](https://raw.githubusercontent.com/Prog-Jacob/course-registration-extension/master/releases/v1.4.55/course_registration_assistant-1.4.55.zip).
...
1. [Click to download extension](https://raw.githubusercontent.com/Prog-Jacob/course-registration-extension/master/releases/v1.4.55/course_registration_assistant-1.4.55.xpi).

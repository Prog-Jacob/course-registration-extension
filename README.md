...
1. [Click to download extension](https://raw.githubusercontent.com/Prog-Jacob/course-registration-extension/master/releases/v1.4.54/course_registration_assistant-1.4.54.zip).
...
1. [Click to download extension](https://raw.githubusercontent.com/Prog-Jacob/course-registration-extension/master/releases/v1.4.54/course_registration_assistant-1.4.54.xpi).
